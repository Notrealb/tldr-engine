...
/// @desc Get instance and collision point of instance with a line between two points. via yellowafterlife
function collision_line_point(x1, y1, x2, y2, obj, prec = true, notme = true) {
