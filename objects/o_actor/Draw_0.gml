	...
	surface_set_target(dodge_outline_surf) { // draw red outline
		...
		for (var i = 0; i < 360; i += 90) {
		    ...
		    s_drawer(spr, image_index, 
				...
				__angle, image_blend, image_alpha
			)
		}
...
s_drawer(spr, image_index, 
	xx, yy, 
	image_xscale, image_yscale, 
	__angle, image_blend, image_alpha * alpha_mod
)
...
if instance_exists(o_eff_lighting_controller) && o_eff_lighting_controller.lighting_alpha > 0 {
    ...
    if lighting_shadow_enabled && o_eff_lighting_controller.shadows
        s_drawer(spr, image_index, 
            ...
            __angle, c_black, image_alpha * o_eff_lighting_controller.lighting_alpha * alpha_mod
        )
}
